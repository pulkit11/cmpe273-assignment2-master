...
import edu.sjsu.cmpe.library.stomp.LibListener;
...
public class LibraryService extends Service<LibraryServiceConfiguration> {
	...
	STOMP apolloSTOMP = new  STOMP(apolloUser, apolloPassword, apolloHost, apolloPort, libraryName, queueName, topicName, bookRepository);
	...
	environment.addServerLifecycleListener(new LibListener(apolloSTOMP));
